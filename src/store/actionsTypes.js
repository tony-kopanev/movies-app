...
export const UNSET_USER_MOVIES = 'UNSET_USER_MOVIES';
...
export const TOGGLE_LOADING_FULL_MOVIE = 'TOGGLE_LOADING_FULL_MOVIE';

// moviesListReducer
export const ADD_MOVIE_DATA_LIST = 'ADD_MOVIE_DATA_LIST';
export const UNSET_FROM_LIST_DATA = 'UNSET_FROM_LIST_DATA';